            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
              { msg &&  <Alerta alerta={alerta}/> }
                ...
                >
                    ...
                    <input type="submit" value='Actualizar Password' className="bg-indigo-700 px-10 py-3 font-bold text-white mt-5 w-full uppercase rounded-lg cursor-pointer hover:bg-indigo-800 "/>
                </form>
            </div>
        </div>
    </>
